...
// melody@Note 08-02-26 --- I know it's not efficient for RSS ಥ⁠‿⁠ಥ
...
export const makeChatsSocket = (config) => {
    ...
    // melody@Note 06-02-26 --- Quick helper only. This function exists solely for faster lookup with caching.
    const findUserId = async (pnLid) => {
        ...
        if (isPnUser(pnLid)) {
            ...
            if (!userId.lid) {
                ...
                return userId; // melody@Note 06-02-26 --- Early return to skip caching for non-existent ID
            }
        }
        ...
        // melody@Note 06-02-26 --- I know... it's dirty (⁠╯⁠︵⁠╰⁠,⁠)
